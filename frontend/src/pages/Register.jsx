...
const Register = () => {
  ...
  const isFormValid =
    nameStatus === "valid" && emailStatus === "valid" && isPasswordValid;
          ...
          <div className="relative z-10 flex flex-col gap-8 xl:gap-10">
            ...
            <div className="space-y-4 max-w-lg">
              ...
              <p className="text-base xl:text-lg text-blue-100/90 font-medium leading-relaxed">
                CareerPilot helps students and professionals analyze resumes,
                identify skill gaps, prepare for interviews and build
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <form className="space-y-5" onSubmit={handleRegister} noValidate>
              ...
              <div>
                ...
                {nameStatus === "invalid" && (
                  <p className="mt-1.5 flex items-center gap-1.5 text-xs font-semibold text-red-500 animate-in fade-in">
                    <XCircle className="w-3.5 h-3.5" /> Name must contain only
              ...
              <div>
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {[
                    ...
                    <div
                      key={key}
                      className={`flex items-center gap-2 text-xs font-medium transition-colors duration-300 ${passwordRules[key] ? "text-emerald-600" : "text-slate-400"}`}
                    >
                      {passwordRules[key] ? (
              ...
              <button
                type="submit"
                disabled={
                  !isFormValid || isLoading || alert?.type === "success"
                }

...
import { Mail, Lock, User, CheckCircle2, ArrowRight, Compass } from 'lucide-react';
      ...
      <div className="w-[90vw] max-w-[1500px] h-[85vh] min-h-[700px] bg-white rounded-3xl shadow-2xl flex flex-col lg:flex-row overflow-hidden border border-slate-200">
        ...
        <div className="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 py-10 sm:px-14 xl:px-20 bg-white overflow-y-auto">
          <div className="w-full max-w-xl mx-auto">
            ...
            <div className="flex lg:hidden items-center gap-3 text-indigo-600 mb-10">
            ...
            {/* Form Header */}
            <div className="mb-10">
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-slate-900 mb-3 tracking-tight">
                Create an account
              </h2>
...
{
  message && (
    <div className="mb-4 p-4 rounded-lg bg-green-100 text-green-700 font-semibold">
      {message}
    </div>
  )
}
<form className="space-y-8" onSubmit={handleRegister}>
  ...
  <div>
    ...
    <div className="relative group">
      <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
        <User className="h-6 w-6 text-slate-400 group-focus-within:text-indigo-600 transition-colors" />
      </div>
      ...
      <input
        ...
        required
        className="block w-full pl-16 pr-5 py-5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 text-lg placeholder:text-lg placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-indigo-600/10 focus:border-indigo-600 focus:bg-white transition-all duration-300 font-medium shadow-sm"
      />
    </div>
  </div>
  ...
  <div>
    ...
    <div className="relative group">
      <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
        <Lock className="h-6 w-6 text-slate-400 group-focus-within:text-indigo-600 transition-colors" />
      </div>
  ...
  <button
    type="submit"
    className="w-full flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white py-5 px-6 rounded-xl font-bold text-xl transition-all duration-300 shadow-[0_4px_14px_0_rgb(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] hover:-translate-y-0.5 mt-8"
  >
    Create Account

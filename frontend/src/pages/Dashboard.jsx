    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col justify-between h-32">
          ...
          <div className="text-3xl font-extrabold text-slate-800">{analysis.atsScore}%</div>
        </div>
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col justify-between h-32">
          <div className="text-slate-500 text-sm font-semibold flex items-center gap-2">
          ...
          <div className="text-3xl font-extrabold text-slate-800">76%</div>
        </div>
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col justify-between h-32">
          <div className="text-slate-500 text-sm font-semibold flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-emerald-50 rounded-2xl p-5 border border-emerald-100">
                ...
                <ul className="space-y-2 text-sm text-emerald-700">
                  {analysis.strengths && analysis.strengths.length > 0 ? (
                    ...
                    <li className="italic text-emerald-600/70">Upload a resume to see strengths.</li>
                  )}
                </ul>
              </div>
              ...
              <div className="bg-red-50 rounded-2xl p-5 border border-red-100">
                ...
                <ul className="space-y-2 text-sm text-red-700">
                  {analysis.weaknesses && analysis.weaknesses.length > 0 ? (
                    ...
                    <li className="italic text-red-600/70">Upload a resume to see weaknesses.</li>
                  )}
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-6">
                <div>
                  ...
                  <p className="font-semibold text-slate-700 text-sm">Junior Developer</p>
                </div>
                <div>
                  <p className="text-xs text-slate-400 font-bold mb-1">NEXT MILESTONE</p>
                  <p className="font-semibold text-indigo-600 text-sm">Advanced Spring Boot</p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm text-center">
            ...
            <h2 className="text-lg font-bold text-slate-800">Ashutosh Jha</h2>
            <p className="text-sm font-medium text-slate-500 mb-4">ATS Score: <span className="font-bold text-indigo-600">{analysis.atsScore}%</span></p>
            <p className="text-xs text-slate-400 mb-6 px-4">Targeting Full Stack Developer roles with a focus on Spring Boot and React.</p>
            <Link to="/profile" className="block w-full bg-slate-50 text-slate-700 py-2.5 rounded-xl font-bold text-sm border border-slate-200 hover:bg-slate-100 transition-colors">
              View Profile
            </Link>
          </div>
          ...
          <div className="bg-indigo-900 rounded-3xl p-6 text-white shadow-sm">
            ...
            <div className="space-y-2 mb-6">
              <div className="bg-white/10 p-3 rounded-xl text-sm border border-white/5">Explain JWT Authentication.</div>
              <div className="bg-white/10 p-3 rounded-xl text-sm border border-white/5">What is Dependency Injection?</div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
            ...
            <div className="relative pl-4 space-y-6 border-l-2 border-slate-100">
              <div className="relative">
                ...
                <h3 className="text-sm font-bold text-slate-800">Interview Questions Generated</h3>
              ...
              <div className="relative">
                ...
                <h3 className="text-sm font-bold text-slate-800">ATS Score Generated</h3>
              ...
              <div className="relative">
                ...
                <h3 className="text-sm font-bold text-slate-800">Resume Uploaded</h3>
                <p className="text-xs text-slate-400 mt-0.5">2 hours ago</p>
              </div>
            </div>
          </div>

  ...
  "Full Stack Developer": [
    {
      ...
      description:
        "Master semantic HTML, responsive CSS, and modern ES6+ JavaScript concepts.",
      status: "active",
    },
    {
      month: "Month 2",
      ...
      description:
        "Learn components, state, props, hooks, and routing using React.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "REST APIs & Node/Spring",
      description:
        "Build scalable RESTful services and understand server-side routing.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Design relational schemas, write complex queries, and manage database performance.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      ...
      description:
        "Containerize applications and deploy them to cloud platforms.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Build and launch a complete end-to-end web application with authentication.",
      status: "upcoming",
    },
  ],
  "Frontend Developer": [
    {
      ...
      title: "HTML + CSS",
      description:
        "Deep dive into web accessibility, Flexbox, Grid, and responsive design.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "JavaScript",
      description:
        "Understand the DOM, async programming, closures, and modern web APIs.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "React",
      description:
        "Build interactive UIs, handle component lifecycles, and use React Hooks.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Implement Redux, Context API, or Zustand for managing complex application state.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Next.js",
      description:
        "Learn server-side rendering, static site generation, and SEO optimization.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Create a stunning personal portfolio with optimized performance and animations.",
      status: "upcoming",
    },
  ],
  "Backend Developer": [
    {
      ...
      description:
        "Learn core syntax, data types, control structures, and object-oriented principles.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "Spring Boot",
      description:
        "Set up enterprise projects, understand dependency injection, and configure beans.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "REST APIs",
      description:
        "Build robust endpoints, handle validation, and document APIs with Swagger/OpenAPI.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      title: "MySQL",
      description:
        "Master SQL, indexing, transactions, and integrate using Hibernate/JPA.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Docker",
      description:
        "Containerize your backend services for consistent cross-environment execution.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      title: "Deployment",
      description:
        "Set up CI/CD pipelines and deploy to AWS, Azure, or Heroku.",
      status: "upcoming",
    },
  ],
  "Java Developer": [
    {
      ...
      title: "Java Core",
      description:
        "Master the basics, memory management, and fundamental language constructs.",
      status: "active",
    },
    {
      month: "Month 2",
      ...
      description:
        "Implement design patterns, inheritance, and utilize the Java Collections Framework.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      ...
      description:
        "Understand concurrency, thread pools, synchronization, and the Executor framework.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      title: "Spring Boot",
      description:
        "Develop rapid, production-ready enterprise applications using Spring Boot.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Microservices",
      description:
        "Break down monoliths into decoupled, independently deployable services.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Develop a scalable, high-performance distributed Java application.",
      status: "upcoming",
    },
  ],
  "Spring Boot Developer": [
    {
      ...
      title: "Java Fundamentals",
      description:
        "Refresh your core Java knowledge with a focus on modern features.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "Spring Core",
      description: "Understand the IoC container, bean scopes, and AOP.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Spring Boot",
      description:
        "Build auto-configured applications with Spring Boot starters and Actuator.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      title: "Security + JWT",
      description:
        "Secure your applications using Spring Security, OAuth2, and JWT tokens.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Microservices",
      description:
        "Implement Service Discovery, API Gateways, and circuit breakers.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Deploy your Spring applications using AWS ECS, Kubernetes, or Spring Cloud.",
      status: "upcoming",
    },
  ],
  "Software Engineer": [
    {
      ...
      description:
        "Master problem-solving techniques, clean code, and basic language syntax.",
      status: "active",
    },
    {
      month: "Month 2",
      ...
      description:
        "Implement Arrays, Linked Lists, Trees, Graphs, and Hash Tables.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Algorithms",
      description:
        "Learn sorting, searching, dynamic programming, and complexity analysis.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Understand load balancing, caching, databases, and architectural trade-offs.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      ...
      description:
        "Build APIs, connect to databases, and handle business logic.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Architect and build a system designed to handle high user traffic.",
      status: "upcoming",
    },
  ],
  "Data Analyst": [
    {
      ...
      title: "Excel",
      description:
        "Master advanced formulas, pivot tables, macros, and data cleaning techniques.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "SQL",
      description:
        "Write complex queries, joins, window functions, and subqueries.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Python",
      description:
        "Learn Pandas, NumPy, and automate data extraction and processing.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Create compelling charts and graphs using Matplotlib and Seaborn.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Power BI",
      description:
        "Build interactive business dashboards and connect to live data sources.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Deliver a comprehensive business insight report from raw data to dashboard.",
      status: "upcoming",
    },
  ],
  "Data Scientist": [
    {
      ...
      title: "Python",
      description:
        "Master Python programming for data manipulation and scientific computing.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "Statistics",
      description:
        "Understand probability, hypothesis testing, distributions, and A/B testing.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Data Analysis",
      description:
        "Perform Exploratory Data Analysis (EDA) using Pandas and visualize trends.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Implement regression, classification, clustering, and ensemble methods using Scikit-Learn.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Deep Learning",
      description:
        "Build neural networks using TensorFlow or PyTorch for complex data patterns.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      title: "End-to-End Data Science Project",
      description: "Train, tune, and deploy a predictive model via a web API.",
      status: "upcoming",
    },
  ],
  "Machine Learning Engineer": [
    {
      ...
      title: "Python",
      description:
        "Master advanced Python, OOP, and software engineering best practices.",
      status: "active",
    },
    {
      month: "Month 2",
      ...
      description:
        "Build robust data pipelines, feature engineering, and handle massive datasets.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Machine Learning",
      description:
        "Train robust ML models, handle bias/variance, and perform cross-validation.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      title: "Deep Learning",
      description:
        "Develop CNNs for vision tasks or RNNs/Transformers for NLP using PyTorch.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      ...
      description:
        "Serve models using FastAPI, Docker, and ONNX for low-latency inference.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Set up MLOps pipelines including model monitoring and automated retraining.",
      status: "upcoming",
    },
  ],
  "DevOps Engineer": [
    {
      ...
      title: "Linux",
      description:
        "Master the command line, bash scripting, file permissions, and process management.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "Git & GitHub",
      description:
        "Manage source code, branch strategies, resolving conflicts, and GitHub Actions.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Docker",
      description:
        "Create multi-stage builds, manage Docker Compose, and optimize image sizes.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      title: "CI/CD",
      description:
        "Build automated testing and deployment pipelines using Jenkins or GitLab CI.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Kubernetes",
      description:
        "Orchestrate containers, manage pods, services, and deployments at scale.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      title: "Cloud Deployment",
      description:
        "Implement Infrastructure as Code (IaC) using Terraform on AWS or Azure.",
      status: "upcoming",
    },
  ],
  "Cloud Engineer": [
    {
      ...
      description:
        "Understand IaaS, PaaS, SaaS, virtualization, and core cloud concepts.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "AWS Core Services",
      description: "Master EC2, S3, IAM, and VPC configurations.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Networking",
      description:
        "Design secure networks, subnets, routing tables, and load balancers.",
      status: "upcoming",
    },
    {
      month: "Month 4",
      ...
      description:
        "Implement scalable storage solutions and manage RDS or DynamoDB.",
      status: "upcoming",
    },
    {
      month: "Month 5",
      title: "Security",
      description:
        "Apply cloud security posture management, encryption, and compliance checks.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Design and deploy a highly available, fault-tolerant cloud architecture.",
      status: "upcoming",
    },
  ],
  "Cyber Security Analyst": [
    {
      ...
      description:
        "Understand the OSI model, TCP/IP, firewalls, and network traffic analysis.",
      status: "active",
    },
    {
      month: "Month 2",
      title: "Linux",
      description:
        "Master Linux administration, logging, and security configurations.",
      status: "upcoming",
    },
    {
      month: "Month 3",
      title: "Security Fundamentals",
      description: "Learn about malware, cryptography, IAM, and the CIA triad.",
      status: "upcoming",
    },
    {
      month: "Month 4",
    ...
    },
    {
      ...
      description:
        "Exploit vulnerabilities securely using Metasploit and Burp Suite.",
      status: "upcoming",
    },
    {
      month: "Month 6",
      ...
      description:
        "Conduct a full security audit, write a report, and recommend remediations.",
      status: "upcoming",
    },
  ],
};
...
const getResourceForMilestone = (title) => {
  ...
  if (t.includes("react"))
    return { doc: "https://react.dev", project: "Build a Portfolio Website" };
  if (t.includes("spring"))
    return {
      doc: "https://spring.io/projects/spring-boot",
      project: "Build JWT Auth API",
    };
  if (t.includes("docker") || t.includes("deployment"))
    return {
  ...
  if (t.includes("sql") || t.includes("mysql") || t.includes("database"))
    return {
      doc: "https://dev.mysql.com/doc/",
      project: "Design an E-commerce Schema",
    };
  if (t.includes("javascript") || t.includes("programming fundamentals"))
    return {
      doc: "https://javascript.info/",
      project: "Build a Task Tracker API",
    };
  if (t.includes("linux"))
    return {
      doc: "https://linuxjourney.com/",
      project: "Automate Backups with Bash",
    };
  if (t.includes("cloud") || t.includes("aws"))
    return {
      doc: "https://aws.amazon.com/getting-started/",
      project: "Deploy a Static Website on S3",
    };
  return {
...
export default function CareerRoadmap() {
  ...
  const completedSteps =
    Object.values(currentRoleProgress).filter(Boolean).length;
  ...
  const nextIncompleteIndex = currentRoadmap.findIndex(
    (_, index) => !currentRoleProgress[index],
  );
  const weeklyGoal =
    nextIncompleteIndex !== -1 ? currentRoadmap[nextIncompleteIndex] : null;
  ...
  const actionPlan =
    recommendations.length > 0
      ? recommendations
      : [
          "Focus on completing your roadmap milestones.",
          "Build projects to strengthen your practical experience.",
        ];
      ...
      <div className="max-w-5xl mx-auto space-y-8 pb-12">
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Your personalized path to bridge skill gaps and land your target
            role.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-12 border border-slate-100 shadow-sm text-center flex flex-col items-center max-w-2xl mx-auto mt-12">
          ...
          <p className="text-slate-500 mb-8 text-center max-w-md">
            Please upload and analyze your resume from the Dashboard to unlock
            personalized career recommendations, timelines, and insights.
          </p>
          <button
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-2 font-medium">
          Your personalized path to bridge skill gaps and land your target role.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2">
          <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col justify-center hover:shadow-md transition-all h-full">
            <label
              htmlFor="role-select"
              className="block text-sm font-bold text-slate-500 mb-3"
            >
      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm mb-8 hover:shadow-md transition-shadow">
        ...
        <div className="space-y-4 lg:hidden">
          {actionPlan.map((rec, idx) => (
            <div
              key={idx}
              className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm"
            >
        ...
        <div className="lg:col-span-2 bg-indigo-50 rounded-3xl p-6 border border-indigo-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
          ...
          {weeklyGoal ? (
            <div className="relative z-10">
              <h4 className="text-xl font-extrabold text-indigo-900 mb-3">
                {weeklyGoal.title}
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-indigo-800 font-medium">
                  <span className="text-indigo-400 mt-0.5">•</span> Read
                  official documentation for {weeklyGoal.title}
                </li>
                <li className="flex items-start gap-2 text-sm text-indigo-800 font-medium">
                  <span className="text-indigo-400 mt-0.5">•</span> Watch a
                  beginner tutorial to grasp core concepts
                </li>
                <li className="flex items-start gap-2 text-sm text-indigo-800 font-medium">
                  <span className="text-indigo-400 mt-0.5">•</span> Build a
                  small practice project applying the skills
                </li>
              </ul>
            </div>
          ) : (
            <div className="relative z-10 py-4 text-center">
              ...
              <p className="text-indigo-600 text-sm mt-1">
                You have completed all milestones for this role.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col hover:border-slate-200 transition-all hover:shadow-md">
          ...
          <ul className="space-y-3 flex-1">
            {roleCertifications[selectedRole]?.map((cert, idx) => (
              <li
                key={idx}
                className="bg-slate-50 border border-slate-100 p-3 rounded-xl text-xs font-bold text-slate-600 flex items-center gap-2 hover:bg-slate-100 transition-colors cursor-default"
              >
                <svg
        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
          {currentRoadmap.map((milestone, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-full border-4 border-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 font-bold z-10 transition-colors ${
                    isCompleted
                ...
                <div
                  className={`w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] bg-slate-50 p-6 rounded-2xl border shadow-sm transition-all ${
                    isCompleted
                      ? "border-emerald-200 opacity-80"
                      : isMissingSkill
                        ? "border-red-300 ring-2 ring-red-50 bg-white hover:shadow-md"
                  ...
                  <div className="pt-4 border-t border-slate-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      <div className="flex-1 flex flex-col justify-center gap-1 text-xs font-bold px-3 py-2 bg-indigo-50 border border-indigo-100 text-indigo-700 rounded-lg">
                        ...
                        <span className="truncate" title={resource.project}>
                          {resource.project}
                        </span>
                      </div>
                    </div>

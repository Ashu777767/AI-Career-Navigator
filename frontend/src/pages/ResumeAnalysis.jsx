  ...
  useEffect(() => {
    const fetchAnalysis = async () => {
      try {
        ...
        setError(
          "Failed to load resume analysis. Please ensure you are logged in and try again.",
        );
        setLoading(false);
      }
    };
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Detailed breakdown of your resume against industry standards.
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm">
          <span className="px-3 py-1.5 bg-indigo-50 text-indigo-600 rounded-lg font-bold">
            1. Docker
          </span>
          <svg
